  ...
  return (
    <section>
      ...
      <p>
        ...
        populares con la introducción de los Hooks. Cada componente en Rect
        puede tener su porpio estado (state) y propiedades (props). El estado es
        ...
        automáticamente en la interfaz del usuario.
      </p>

      <div class="alert alert-info" role="alert">
        Comisión: {props.comision} Módulo: ---
      </div>
    </section>
  );
};
